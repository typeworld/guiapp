...
options = {'py2app': {'argv_emulation': False, # this puts the names of dropped files into sys.argv when starting the app.
           ...
           'includes': ['ynlib', 'importlib_metadata', 'os', 'markdown'],#, 'os', 'webbrowser', 'urllib', 'base64', 'keyring'],
           ...
           'packages': ['certifi', 
              'encodings', 'codecs', 'io', 'abc', 'os', 'stat', 'typeWorld', 'keyring', 'importlib', 'pystray', 'markdown', 'pkg_resources'],
