...
executeCommands((
	...
	('Copying google-api-core', f'cp -R {sitePackages}/google_api_core-*.pth dist/Type.World.app/Contents/Resources/lib/python3.7', True),
	('Copying google-api-core', f'cp -R {sitePackages}/google_api_core-*.dist-info dist/Type.World.app/Contents/Resources/lib/python3.7', True),
