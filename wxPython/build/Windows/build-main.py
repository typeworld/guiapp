    ...
    executeCommands(
        [
            [
                ...
                f'"{windowskitbin}\\signtool.exe" sign /sm /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /a /n "Jan Gerner" "build\\TypeWorld.exe"',
                True,
            ],
            [
                "Signing TypeWorld Subscription Opener.exe",
                f'"{windowskitbin}\\signtool.exe" sign /sm /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /a /n "Jan Gerner" "build\\TypeWorld Subscription Opener.exe"',
                True,
            ],
            [
                "Verify signature",
