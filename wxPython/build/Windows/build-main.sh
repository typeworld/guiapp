...
"$WINDOWSKITBIN\\signtool.exe" sign /sm /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /n "Jan Gerner" /p $JANGERNER_P12_PASSWORD "build\\TypeWorld.exe"
...
"$WINDOWSKITBIN\\signtool.exe" sign /sm /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /n "Jan Gerner" /p $JANGERNER_P12_PASSWORD "build\\TypeWorld Subscription Opener.exe"
