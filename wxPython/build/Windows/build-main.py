    ...
    executeCommands(
        [
            [
                ...
                f'"{windowskitbin}\\signtool.exe" sign /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /f JANGERNER.pfx /p "{p12password}" "build\\TypeWorld.exe"',
            ...
            [
                ...
                f'"{windowskitbin}\\signtool.exe" sign /tr http://timestamp.digicert.com /debug /td sha256 /fd SHA256 /f JANGERNER.pfx /p "{p12password}" "build\\TypeWorld Subscription Opener.exe"',
