...
blob = bucket.blob(f'downloads/guiapp/TypeWorldApp.{version}.exe')
blob.upload_from_filename(filename=f'/Users/yanone/Code/TypeWorldApp/dmg/TypeWorldApp.{version}.exe')
