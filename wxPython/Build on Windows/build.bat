...
"Z:\Code\Windows\Dev Tools\mt.exe" -manifest "Z:\Code\py\git\typeWorld\guiapp\wxPython\Build on Windows\windowsAppManifest.xml" -outputresource:Z:\Code\TypeWorldApp\Windows\Main\TypeWorld.exe;#1
...
Z:\Code\TypeWorldApp\Windows\Main\TypeWorld.exe
